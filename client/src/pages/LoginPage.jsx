  ...
  return (
    <div className="max-w-md mx-auto p-6 md:p-8 bg-white rounded-3xl shadow-xl border border-slate-100 mt-10">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-slate-900 mb-2 tracking-tight">Log in to your account</h1>
      ...
      {pendingIdToken ? (
        ...
        <>
          ...
          <div className="space-y-3 mb-6">
            ...
            <button type="button" onClick={() => handleSocialAuth(facebookProvider)} className="w-full flex items-center justify-between px-5 py-3.5 border border-slate-200 rounded-2xl bg-white hover:bg-slate-50 transition-colors group">
              <div className="flex items-center gap-3">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="#1877F2">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
                <span className="font-semibold text-slate-800 text-sm">Continue with Facebook</span>
              </div>
              <svg className="w-5 h-5 text-slate-400 group-hover:text-slate-600 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
              </svg>
      ...
      <div className="relative flex items-center mb-6">
        ...
        <span className="flex-shrink-0 mx-4 text-slate-400 text-[10px] sm:text-xs uppercase tracking-wider">or sign in with email</span>
        <div className="flex-grow border-t border-slate-100"></div>
      </div>
      ...
      <div className="mt-8 text-center px-4">
        <p className="text-[11px] text-slate-500 leading-relaxed">
          By logging in, you agree to our <a href="#" className="text-emerald-600 hover:underline">Terms of Service</a> and <a href="#" className="text-emerald-600 hover:underline">Privacy Policy</a>.
        </p>
      </div>
    </div>
  );
